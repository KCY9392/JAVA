...
public class ConsumerTest {
	...
	static BiConsumer<String, Integer> c3 =
			(product, price) -> System.out.println(product+"의 가격은 "+price+"원 입니다");
	
			
	// 4) ObjXXXConsumer<T> : T타입인자 1개 + XXX타입 인자값 1개를 가진다.
	static ObjIntConsumer<Product> c4 =
			(product, price) -> System.out.println(product.getpName()+"의 가격은 "+price+"원 입니다.");
